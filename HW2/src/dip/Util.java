...
public class Util {
	...
	public static int [] bilinearColor(int [][][] data, double x, double y) {
		...
		int [] colorA = Util.getInterpolationColor(color1, color2, x - fX),
				colorB = Util.getInterpolationColor(color3, color4, x - fX);

		return Util.getInterpolationColor(colorA, colorB, y - fY);
	}
